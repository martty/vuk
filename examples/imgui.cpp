...
void util::ImGui_ImplVuk_Render(vuk::Allocator& allocator, vuk::RenderGraph& rg, vuk::Name src_target, vuk::Name dst_target, util::ImGuiData& data, ImDrawData* draw_data) {
	...
	auto imvert = ctx.allocate_buffer(allocator, vuk::MemoryUsage::eGPUonly, vertex_size, 1);
	auto imind = ctx.allocate_buffer(allocator, vuk::MemoryUsage::eGPUonly, index_size, 1);
